...
export default function HadidManagement() {
    const navigate = useNavigate();

    // Mock data matching the headers in your image
    const [tableData, setTableData] = useState([
        { id: 1, title: "Hadith for Morning Protection", category: "Morning Azkar", arabic: "بِسْمِ اللَّهِ الَّذِي لَا يَضُرُّ مَعَ اسْمِهِ شَيْءٌ...", audio: "Available", published: true },
        ...
        { id: 3, title: "Hadith Before Sleep", category: "Morning Azkar", arabic: "بِسْمِ اللَّهِ الَّذِي لَا يَضُرُّ مَعَ اسْمِهِ شَيْءٌ...", audio: "Available", published: true },
        { id: 4, title: "Hadith for Morning Protection", category: "Morning Azkar", arabic: "بِسْمِ اللَّهِ الَّذِي لَا يَضُرُّ مَعَ اسْمِهِ شَيْءٌ...", audio: "Missing", published: false },
        { id: 5, title: "Hadith for Morning Protection", category: "Morning Azkar", arabic: "بِسْمِ اللَّهِ الَّذِي لَا يَضُرُّ مَعَ اسْمِهِ شَيْءٌ...", audio: "Available", published: true },
    ]);
    ...
    return (
        <div className="w-full p-2">
            ...
            <div className="flex justify-between items-center mb-10">
                ...
                <button
                    onClick={() => navigate("/hadith_management/add_hadith")}
                ...
                >
                    <span className="text-2xl font-light">+</span>Add New Hadith
                </button>
            </div>
                            ...
                            <tr key={row.id} className="hover:bg-gray-50 transition-colors relative hover:cursor-pointer">
                                ...
                                <td className="px-6 py-5">
                                    <div className="flex items-center justify-center gap-4">
                                        <Link
                                            to={`/hadith_management/hadith_details/${row.id}`}
                                        ...
                                        <Link
                                            to={`/hadith_management/edit_hadith/${row.id}`}
